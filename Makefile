...
compiler := $(CXX)
compilation_flags := -Wall -Wno-unused-command-line-argument -std=c++17 -O3 `pkg-config --cflags --libs gtk4 gstreamer-1.0 gstreamer-app-1.0` -Ilibdatachannel/include
libraries := -lSDL2 -lGLEW -lGL -lXi -lX11 -lssl -lcrypto
...
obj/config_0.o: ./config.cpp ./config.hpp ./glib.hpp
	@printf '\033[1m[POLYBUILD]\033[0m Compiling $@ from $<...\n'
	@mkdir -p obj
	@$(compiler) -c $< $(compilation_flags) -o $@
	@printf '\033[1m[POLYBUILD]\033[0m Finished compiling $@ from $<!\n'
...
lux-desktop: obj/main_0.o obj/config_0.o obj/video_0.o obj/keys_0.o obj/string_0.o obj/client_0.o obj/polyweb_0.o obj/websocket_0.o obj/server_0.o obj/polynet_0.o obj/secure_sockets_0.o
