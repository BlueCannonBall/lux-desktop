...
compiler := $(CXX)
compilation_flags := -Wall -Wno-unused-command-line-argument -std=c++17 -O3 `pkg-config --cflags --libs gtk4 gstreamer-1.0` -Ilibdatachannel/include
libraries := -lXi -lX11 -lssl -lcrypto
