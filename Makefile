...
compiler := $(CXX)
compilation_flags := -Wall -std=c++17 -O3 -march=native -mtune=native -pthread -Ilibdatachannel/include `pkg-config --cflags sdl2 gstreamer-video-1.0 gstreamer-app-1.0 gstreamer-1.0 nice gio-2.0`
...
ifeq ($(OS),Windows_NT)
	compilation_flags := -Wall -std=c++17 -O3 -march=native -mtune=native -pthread -static-libgcc -static-libstdc++ -Ilibdatachannel/include `pkg-config --cflags sdl2 gstreamer-video-1.0 gstreamer-app-1.0 gstreamer-1.0 nice gio-2.0`
	...
	static_libraries := libdatachannel/build/libdatachannel.dll.a libdatachannel/build/deps/libsrtp/libsrtp2.a libdatachannel/build/deps/usrsctp/usrsctplib/libusrsctp.a
endif
